...
RUN mkdir -p /var/www/goldmine/api/current
ADD ./nginx/goldmine /etc/nginx/sites-available/
RUN ln -s /etc/nginx/sites-available/goldmine /etc/nginx/sites-enabled/goldmine
